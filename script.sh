...
#SBATCH --output=/home/bwd29/self-join/results/tree2.out
#SBATCH --error=/home/bwd29/self-join/results/tree2.err
#SBATCH --time=3000:00
#SBATCH --mem=0
#SBATCH -c 64 
#SBATCH -G 3
...
echo -e "\nEPSILON | NUMPOINTS | RP | Construct T | Kernel T | Total T\n" >&2
                ...
                do
                        ...
                        do
                                ...
                                do
                                        ...
                                        do
                                                ./build/main /scratch/bwd29/data/USC_Normalized_No1Col.bin 68 7 $j
                                        done

                                        # make clean
                                        # BS=$i KB=$t DIM=49 ILP=$l make
