...
#SBATCH --output=/home/bwd29/self-join/results/calcMinTest1.out
#SBATCH --error=/home/bwd29/self-join/results/calcMinTest1.err
#SBATCH --time=3000:00
#SBATCH --mem=0
#SBATCH -c 64
#SBATCH -G 4
...
echo -e "\nEPSILON | NUMPOINTS | MIN_NODE_SIZE | CALC_MULTI | RP | NODES | CALCS | Construct T | Total T\n" >&2
        ...
        do
                ...
                do
                        make clean
                        CALC_MULTI=$k MIN_NODE_SIZE=$i make
