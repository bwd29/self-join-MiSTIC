...
#SBATCH --output=/home/bwd29/self-join/results/treeNewRPStrat3Metrics.out
#SBATCH --error=/home/bwd29/self-join/results/treeNewRPStrat3Metrics.err
#SBATCH --time=3000:00
#SBATCH --mem=0
#SBATCH -c 64 
#SBATCH -G 3
        ...
        do
                ...
                do
                        ...
                        do
                                ...
                                do
                                        make clean
                                        TPP=$k RP=$l BS=$i KB=$t DIM=90 ILP=4 make
                                        # make
                                        ...
                                        make clean
                                        TPP=$k RP=$l BS=$i KB=$t DIM=49 ILP=4 make
                                        ...
                                        make clean
                                        TPP=$k RP=$l BS=$i KB=$t DIM=57 ILP=4 make
                                        ...
                                        make clean
                                        TPP=$k RP=$l BS=$i KB=$t DIM=18 ILP=4 make
                                        ...
                                        make clean
                                        TPP=$k RP=$l BS=$i KB=$t DIM=28 ILP=4 make
