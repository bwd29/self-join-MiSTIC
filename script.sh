...
#SBATCH --output=/home/bwd29/self-join/results/results2Fixed.out
#SBATCH --error=/home/bwd29/self-join/results/error2Fixed.err
#SBATCH --time=3000:00
#SBATCH --mem=0
#SBATCH -c 64
#SBATCH -G 3
...
echo "device building, 1024x1024*2 launches, sqrt(N) x 0.01 sampling, 32 per layer, k rps, non-rand RP, dynamic calcs per thread max 250000, 30 registers"
