...
#SBATCH --output=/home/bwd29/self-join/results/resultsf1.out
#SBATCH --error=/home/bwd29/self-join/results/errorf1.err
#SBATCH --time=3000:00
#SBATCH --mem=0
#SBATCH -c 64
#SBATCH -G 3
...
echo "1024x1024 launches, sqrt(N) x 0.01 sampling, 64 per layer, 6 rps, non-rand RP, dynamic calcs per thread max 250000, 30 registers"
